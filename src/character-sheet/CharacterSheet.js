...
import {
  ...
  from "@mui/material";
import './App.css';
import BasicInformation from './character-sheet/BasicInformation';
import LeftColumn from './character-sheet/LeftColumn';
import MiddleColumn from './character-sheet/MiddleColumn';
import RightColumn from './character-sheet/RightColumn';
import Dialogs from './character-sheet/Dialogs';
import {
  BRUTE_SCORES,
  CASTER_SCORES,
  DEFAULT_CHARACTER,
