...
export const WEAPON_PROPERTIES = {
    ...
    improvisedWeapon: {
        ...
        description: "Sometimes character don't have their weapons and must attack with whatever is at hand. An improvised weapon includes any object you can wield in one or two hands, such as a shard of broken glass, a table leg, or whatever else comes to hand. Often, an improvised weapon is similar enough to an actual weapon to be treated as such. For example, a table leg is akin to a club. At the GM's discretion, a character proficient with a weapon can use a similar object as if it were that weapon and use his or her proficiency bonus. An object that bears no resemblance to a weapon deals 1d4 damage (the GM assigns a damage type appropriate to the object). If a character uses a ranged weapon to make a melee attack, or throws a melee weapon that does have the thrown property, it also deal 1d4 damage. An improvised thrown weapon has a normal range of 20 feet and a long range of 60 feet."
    },
    thrown: {
        name: "Thrown",
        description: "If a weapon has the thrown property, you can throw the weapon to make a range attack. If the weapon is a melee weapon, you use the same ability modifier for that attack roll and damage roll that you would use for a melee attack with the weapon. For example, if you throw a handaxe you use your Strength, but if you throw a dagger you can use either your Strength or your Dexterity, since the dagger has the finesse property."
    },
    versatile: {
        name: "Versatile",
        description: "This weapon can be used with one or two hands. A damage value in parenthese appears with the property--the damage when the weapon is used with two hands to make a melee attack."
    },
    finesse: {
        name: "Finesse",
        description: "When making an attack with a finesse weapon, you may choose to use either your Strength or Dexterity modifier for the attack and damage rolls. You must use the same modifier for both rolls."
    },
    heavy: {
        name: "Heavy",
        description: "Small creatures have disadvantage on attack rolls with heavy weapons. A heavy weapon's size and bulk make it too large for a Small or Tiny creature to use effectively."
    },
    light: {
        name: "Light",
    ...
    loading: {
        name: "Loading",
        description: "Because of the time required to load this weapon, you can fire only one piece of ammunition from it when use an action, bonus action, or reaction to fire it, regardless of the number of attack you can normally make."
    },
    reach: {
        name: "Reach",
        description: "This weapon adds 5 feet to your reach when you attack with it, as well as when detemrining your reach for opportunity attacks with it."
    },
    range: {
        name: "Range",
